...
public class AimTurretPlayer : MonoBehaviour
{
    ...
    public void Aim (Vector2 inputPointerPosition)
    {
        ...
        transform.rotation = Quaternion.RotateTowards(transform.rotation, Quaternion.Euler(0, 0, desiredAngle), rotatrionStep);
